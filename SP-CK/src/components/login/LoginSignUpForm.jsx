    ...
    return (
        <>
            <style>{`
                ...
                .error-message { color: #ff3860; font-size: 0.9rem; margin-top: 10px; text-align: center; height: 1rem; }
                ...
                <div className="forms-container">
                    <div className="signin-signup">
                        <form onSubmit={handleSubmit} className="sign-in-form">
                            ...
                            <div className="error-message">{error && !isSignUpMode ? error : ''}</div>
                            <button type="submit" disabled={isLoading} className="btn solid">{isLoading ? '...' : 'Login'}</button>
                        </form>
                        <form onSubmit={handleSubmit} className="sign-up-form">
                            ...
                            <div className="error-message">{error && isSignUpMode ? error : ''}</div>
                            <button type="submit" disabled={isLoading} className="btn">{isLoading ? '...' : 'Sign up'}</button>
                        </form>
                    </div>
                </div>
